---
archivedFrom: docs/data/orders.md
---
...
```json
[
  { "id": 1, "order_code": "ORD000001", "shop_no": "SHOP1", "ordered_qty": 2, "payment_amount": 11000, "status": "결제완료" },
  { "id": 2, "order_code": "ORD000002", "shop_no": "SHOP2", "ordered_qty": 1, "payment_amount": 12000, "status": "배송중" }
]
```
